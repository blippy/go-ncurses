...
func main() {
	...
	win1 := goncurses.NewWin(5, width, 0, 0)
	win1.ScrollOk(true)
	win1.AttrSet(goncurses.AttrBold)
	win2 := goncurses.NewWin(height-6, width, 5, 0)
	win2.ScrollOk(true)
	win3 := goncurses.NewWin(1, width, height-1, 0)
